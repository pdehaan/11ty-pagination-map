...
const map = [
  ...
  ["Exodus", { chapters: [["one", "two", "three", "four"]] }],
  ["Psalm", { chapters: [["one", "two", "three", "four", "five", "six"]] }],
  ["Proverbs", { chapters: [["one", "two", "three", "four"]] }],
  ["1 Soloman", { chapters: [["one", "two"]] }],
  ["Ruth", { chapters: [["one", "two"]] }],
...
module.exports = map.reduce((coll, [name, data]) => {
  const slug = slugify(name);
  coll[slug] = Object.assign({ name, slug }, data);
  return coll;
}, {});
 ...
 * SAMPLE OUTPUT
    {
      'genesis': { name: 'Genesis', slug: 'genesis', chapters: [ [Array], [Array] ] },
      'exodus': { name: 'Exodus', slug: 'exodus', chapters: [ [Array] ] },
      'psalm': { name: 'Psalm', slug: 'psalm', chapters: [ [Array] ] },
      'proverbs': { name: 'Proverbs', slug: 'proverbs', chapters: [ [Array] ] },
      '1-soloman': { name: '1 Soloman', slug: '1-soloman', chapters: [ [Array] ] },
      'ruth': { name: 'Ruth', slug: 'ruth', chapters: [ [Array] ] }
    }
*/
